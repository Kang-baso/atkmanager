...
<div class="panel panel-default">
  <div class="panel-heading">
    <h3 class="panel-title">Beri Penilaian Permintaan</h3>
  </div>
  <div class="panel-body">
  <h3>Yakin untuk menyetujui Permintaan ini ?</h3>
  	<form method="post" action="" id="form-acc-permintaan">
...
$(document).ready(function(){
  $('#submit').click(function(){
      $.ajax({
        type: 'post',
        url: 'pages/model/acc-permintaan-simpan.php',
        data: $('#form-acc-permintaan').serialize(),
